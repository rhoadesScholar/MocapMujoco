...
"""
#     py mocap_render_test.py --fileName='ratmocap.mat' --varName='markers_aligned_preproc'
...
def main(unused_argv):
  ...
  for i in range(FLAGS.start_frame, max_frame, FLAGS.frame_step):
    ...
    with env.physics.reset_context():
      ...
      env.physics.triggers_dirty = True     #STILL DOESN"T UPDATE SKELETON WITH MOCAP UPDATES

...
function_pointers = collections.namedtuple(
    ...
    ['mjcb_passive',
     ...
     'mjcb_act_gain',
     'mjcb_act_bias']
)(ctypes.c_void_p.in_dll(mjlib, 'mjcb_passive'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_control'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_contactfilter'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_sensor'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_time'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_act_dyn'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_act_gain'),
  ctypes.c_void_p.in_dll(mjlib, 'mjcb_act_bias'))
